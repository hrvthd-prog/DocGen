...
const suites = ['auto-tests.js', 'employee-repo.test.js', 'schema.test.js', 'schema-from-xlsx.test.js', 'xlsx.test.js', 'docgen-resolve.test.js', 'logger.test.js', 'vbs-encoding.test.js', 'cases.test.js', 'e2e.test.js', 'sdt-checkbox.test.js'];
let failedSuites = 0;
